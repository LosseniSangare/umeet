...
if (isset($_POST['titre']) && isset($_POST['contenu'])&&(!isset($_POST['id']))){
	...
	$requete = $bd->prepare('INSERT INTO infos(titre,contenu, dates)VALUES(:titre, :contenu, now()) ');
	...
	$requete = $bd->prepare('UPDATE infos SET titre=:titre,contenu=:contenu, dates= now() WHERE id = :id ');
	$requete->execute(array(
		'id' =>  $_POST['id'],
		'titre' =>  $titre,
		'contenu' =>  $contenu
